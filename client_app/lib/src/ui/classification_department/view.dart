...
class _DepartmentClassificationViewState
  ...
  Widget build(BuildContext context) {
    ...
    final listDepartmentClassificationRankingCo2 =
        viewModel.uiState.listDepartmentClassification;

    final firstRankingCo2 = listDepartmentClassificationRankingCo2.isNotEmpty
        ? listDepartmentClassificationRankingCo2.first
        : null;

    final userValues = viewModel.uiState.userDepartmentClassification!;
