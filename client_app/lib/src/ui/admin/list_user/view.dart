...
class _AdminListUserViewState extends State<AdminListUserView>
  ...
  @override
  String? get restorationId => 'list_user_table_etichetta';

  @override
  void restoreState(RestorationBucket? oldBucket, bool initialRestore) {
    registerForRestoration(_rowIndex, 'current_user_row_index');
  }
  ...
  Widget build(BuildContext context) {
    ...
    _tableDataSource = _TableDataSource(
      ...
      onTap: (user) async {
        ...
        if (dashboardModel.uiState.userInfo != null) {
              ...
              DataColumn(
                label: DataColumnSearch(
                  ...
                  onFilterChange: (value) {
                    if (value != null) {
                      _rowIndex.value = 0;
                      dashboardModel.searchUserEmailListUser(value);
                    } else {
                      _rowIndex.value = 0;
                      dashboardModel.clearSearchUserEmailListUser();
                    }
                  },
                ),
              ),
